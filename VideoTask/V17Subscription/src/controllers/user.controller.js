...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (!avatarLocalPath) {
    ...
    throw new ApiError(
      400,
      "Avatar file is required. Make sure it's uploaded correctly."
    );
  }
...
export { registerUser,loginUser,generateAccessAndRefereshTokens,logoutUser,updateAccountDetails };
